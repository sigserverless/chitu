...
#     dserver = DServer()
#     dserver.trigger_F("dp-case-2-rs")
    
#     from multiprocessing import cpu_count
#     print("CPU的核数为：{}".format(cpu_count()), flush=True)
...
#             ddict1 = dserver.new_D("ddict1_"+ str(count))
#             ddict1.register_params(model.named_parameters())
#             ddict2 = dserver.import_D("ddict2_"+str(count), False) 
#             ddict_res = dserver.merge_Ds("ddict_res_"+str(count), [ddict1, ddict2])
#             dserver.export_D(ddict_res, "ddict_res_"+str(count))
#             optimizer.zero_grad()
#             # 注册完成
